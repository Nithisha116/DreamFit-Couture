 ...
 * Renders live styled CustomerOrderCard on all devices — no html2canvas on mobile.
 */
export default function PublicOrderCardView() {
  ...
  return (
    <div className="min-h-screen bg-slate-200 py-4 sm:py-10 print:bg-white print:py-0">
