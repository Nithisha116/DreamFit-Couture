...
//   X,
// } from "lucide-react";
// import { fetchAariWorkerById, updateAariWorker } from "../../../features/aariWorker/aariWorkerSlice";
// import showToast from "../../../utils/toast";

// export default function EditAariWorker() {
//   const { id } = useParams();
//   const navigate = useNavigate();
//   const dispatch = useDispatch();
  
//   const { currentAariWorker, loading } = useSelector((state) => state.aariWorker);
...
//   const canEditBasic = isAariWorkerSelf;
...
//       setFormData({
//         name: currentAariWorker.name || "",
//         phone: currentAariWorker.phone || "",
//         email: currentAariWorker.email || "",
//         address: {
//           street: currentAariWorker.address?.street || "",
//           city: currentAariWorker.address?.city || "",
//           state: currentAariWorker.address?.state || "",
//           pincode: currentAariWorker.address?.pincode || ""
//         },
//         specialization: currentAariWorker.specialization || [],
//         experience: currentAariWorker.experience || "",
//       });
//     }
//   }, [currentAariWorker]);
...
//     // Validation
//     if (!formData.name) {
//       showToast.error("Please enter aariWorker name");
//       return;
//     }
...
//     try {
//       await dispatch(updateAariWorker({ id, aariWorkerData: formData })).unwrap();
//       showToast.success("AariWorker updated successfully! 🎉");
//       // ✅ Navigate with basePath
//       navigate(`${basePath}/aari-workers/${id}`);
//     } catch (error) {
//       showToast.error(error || "Failed to update aariWorker");
//     } finally {
...
//         </button>
//         <div>
//           <h1 className="text-3xl font-black text-slate-800 tracking-tight">Edit Aari Worker</h1>
//           <p className="text-slate-500">Update aariWorker information</p>
//         </div>
//       </div>
  ...
  useEffect(() => {
    if (currentAariWorker) {
      setFormData({
        ...
        specialization: currentAariWorker.specialization || [],
        experience: currentAariWorker.experience || "",
        basicSalary: currentAariWorker.basicSalary || 0,
      });
    }
  }, [currentAariWorker]);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="hidden lg:flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-black text-slate-800 tracking-tight">Edit Aari Worker</h1>
            <p className="text-sm lg:text-base text-slate-500">Update aariWorker information</p>
          </div>
        </div>
          ...
          <div className="space-y-4 sm:space-y-5 lg:space-y-6">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    {formData.specialization.length > 0 ? (
                      ...
                      <div className="text-center p-4 sm:p-5 bg-slate-50 rounded-lg sm:rounded-xl border border-slate-200">
                        <Wand2 size={20} className="mx-auto text-slate-400 mb-2" />
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
              ...
              <ul className="list-disc list-inside text-[10px] sm:text-xs text-blue-700 space-y-1">
                ...
                {!canEditAll && !canEditBasic && (
                  <li>You don't have permission to edit this aariWorker</li>
                )}
              </ul>
            </div>
