...
//   Lock,
// } from "lucide-react";
// import { createAariWorker } from "../../../features/aariWorker/aariWorkerSlice";
// import showToast from "../../../utils/toast";

// export default function AddAariWorker() {
...
//       data: {
//         ...aariWorkerData,
//         password: aariWorkerData.password ? "[PRESENT - " + aariWorkerData.password.length + " chars]" : "[MISSING - THIS IS THE PROBLEM!]"
//       },
//       passwordLength: aariWorkerData.password ? aariWorkerData.password.length : 0,
...
//       console.log("🔍 STEP 5 - About to dispatch createAariWorker with password:", 
//         aariWorkerData.password ? "[PRESENT]" : "[MISSING]");
      
//       const result = await dispatch(createAariWorker(aariWorkerData)).unwrap();
      
//       console.log("✅ STEP 6 - Dispatch successful:", result);
      
//       // Show success message with password if it was auto-generated
//       if (!formData.password) {
//         showToast.success(`AariWorker created successfully! Password: ${password}`, {
//           duration: 10000, // Show for 10 seconds so admin can note it down
//         });
//       } else {
//         showToast.success("AariWorker created successfully! 🎉");
//       }
...
//         } else {
//           showToast.error("Failed to create aariWorker");
//         }
...
//         showToast.error(error.message || "Failed to create aariWorker");
//       }
//     } finally {
...
//         </button>
//         <div>
//           <h1 className="text-3xl font-black text-slate-800 tracking-tight">Add New Aari Worker</h1>
//           <p className="text-slate-500">Create a new aariWorker profile</p>
//         </div>
//       </div>
...
//                   placeholder="Enter aariWorker's full name"
...
//                     onChange={handleChange}
//                     placeholder="aariWorker@example.com"
//                     className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all"
//                   />
//                 </div>
//               </div>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="hidden lg:flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-black text-slate-800 tracking-tight">Add New Aari Worker</h1>
            <p className="text-sm lg:text-base text-slate-500">Create a new aariWorker profile</p>
          </div>
        </div>
