...
//   X,
// } from "lucide-react";
// import { fetchHelperById, updateHelper } from "../../../features/helper/helperSlice";
...
//   const { currentHelper, loading } = useSelector((state) => state.helper);
...
//   const canEditBasic = isHelperSelf;
...
//         phone: currentHelper.phone || "",
//         email: currentHelper.email || "",
//         address: {
//           street: currentHelper.address?.street || "",
//           city: currentHelper.address?.city || "",
//           state: currentHelper.address?.state || "",
//           pincode: currentHelper.address?.pincode || ""
//         },
//         specialization: currentHelper.specialization || [],
//         experience: currentHelper.experience || "",
//       });
//     }
//   }, [currentHelper]);
...
//     // Validation
//     if (!formData.name) {
//       showToast.error("Please enter helper name");
//       return;
//     }
...
//     try {
//       await dispatch(updateHelper({ id, helperData: formData })).unwrap();
//       showToast.success("Helper updated successfully! 🎉");
//       // ✅ Navigate with basePath
//       navigate(`${basePath}/helpers/${id}`);
//     } catch (error) {
//       showToast.error(error || "Failed to update helper");
//     } finally {
...
//         </button>
//         <div>
//           <h1 className="text-3xl font-black text-slate-800 tracking-tight">Edit Helper</h1>
//           <p className="text-slate-500">Update helper information</p>
//         </div>
//       </div>
  ...
  useEffect(() => {
    if (currentHelper) {
      setFormData({
        ...
        specialization: currentHelper.specialization || [],
        experience: currentHelper.experience || "",
        basicSalary: currentHelper.basicSalary || 0,
      });
    }
  }, [currentHelper]);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="hidden lg:flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-black text-slate-800 tracking-tight">Edit Helper</h1>
            <p className="text-sm lg:text-base text-slate-500">Update helper information</p>
          </div>
        </div>
          ...
          <div className="space-y-4 sm:space-y-5 lg:space-y-6">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    {formData.specialization.length > 0 ? (
                      ...
                      <div className="text-center p-4 sm:p-5 bg-slate-50 rounded-lg sm:rounded-xl border border-slate-200">
                        <UserCog size={20} className="mx-auto text-slate-400 mb-2" />
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
              ...
              <ul className="list-disc list-inside text-[10px] sm:text-xs text-blue-700 space-y-1">
                ...
                {!canEditAll && !canEditBasic && (
                  <li>You don't have permission to edit this helper</li>
                )}
              </ul>
            </div>
