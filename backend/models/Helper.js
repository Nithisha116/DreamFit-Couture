...
//     // 1. Generate helperId if not exists
//     if (!this.helperId) {
//       console.log("📝 Generating new helperId...");
//       const date = new Date();
//       const year = date.getFullYear().toString().slice(-2);
//       const month = String(date.getMonth() + 1).padStart(2, '0');
      
//       const count = await mongoose.model("Helper").countDocuments();
//       const sequence = String(count + 1).padStart(4, '0');
      
//       this.helperId = `AAR${year}${month}${sequence}`;
//       console.log(`✅ Generated helperId: ${this.helperId}`);
//     }
...
// helperSchema.virtual('fullAddress').get(function() {
...
helperSchema.index({ email: 1, phone: 1 });
